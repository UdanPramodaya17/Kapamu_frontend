      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: '100%', maxWidth: '360px', zIndex: 1 }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', padding: '1.25rem 0' }}>
            ...
            <span style={{ flexShrink: 0, margin: '0 1rem', color: 'rgba(0,0,0,0.4)', fontSize: '0.7rem', fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Or sign in with</span>
            <div style={{ flexGrow: 1, borderTop: '1px solid rgba(0,0,0,0.08)' }}></div>
          </div>
