    ...
    return (
        <div style={{ minHeight: '100vh', background: '#ffffff', color: '#000000', display: 'flex', position: 'relative', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <div className="hidden md:flex md:w-[45%] lg:w-[50%]" style={{
                ...
                padding: '3.5rem',
                backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.75)), url(${loginImg})`,
                ...
                <div style={{ position: 'relative', zIndex: 1, maxWidth: '440px' }}>
                    ...
                    <h2 style={{
                        ...
                        Welcome to<br />
                        <em style={{ fontStyle: 'italic', color: 'rgba(255,255,255,0.7)' }}>Kapamu</em>
                    </h2>
                    <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '0.85rem', color: 'rgba(255,255,255,0.75)', lineHeight: 1.6 }}>
                        You've been invited to join Kapamu as an Admin. Set up your password to access your personalized dashboard.
                    </p>
                </div>
                ...
                <div style={{ position: 'relative', width: '100%', maxWidth: '360px', zIndex: 1 }}>
                    ...
                    <div style={{ marginBottom: '2.5rem' }}>
                        <div style={{
                            ...
                            <Sparkles size={12} style={{ color: 'rgba(0,0,0,0.5)' }} />
                            <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.5)' }}>Admin Invite</span>
                        </div>
                        <h1 style={{
                            fontFamily: "'Plus Jakarta Sans', sans-serif",
                            fontWeight: 800,
                        ...
                        <p style={{ color: 'rgba(0,0,0,0.45)', fontSize: '0.8rem', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                            Create a secure password for your Saloon Admin account.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                            {['6+ characters', 'Mix of letters', 'Numbers help'].map(hint => (
                                <span key={hint} style={{
                                    fontSize: '0.65rem', fontFamily: "'Plus Jakarta Sans', sans-serif",
                                    fontWeight: 600, letterSpacing: '0.05em',
                                    color: 'rgba(0,0,0,0.35)', padding: '0.2rem 0.6rem',
